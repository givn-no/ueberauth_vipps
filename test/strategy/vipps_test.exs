defmodule Ueberauth.Strategy.VippsTest do
  ...
  test "handle_callback! assigns required fields on successful auth" do
    conn = conn(:get, "/auth/vipps/callback", %{code: "success_code"})
  ...
  test "uid_field is picked according to the specified option" do
    conn = conn(:get, "/auth/vipps/callback", %{code: "uid_code"})
  ...
  test "userinfo is fetched according to userinfo_endpoint" do
    conn = conn(:get, "/auth/vipps/callback", %{code: "userinfo_code"})
